...
#define MINI_PPN3_OFFSET		0x34	//k8 use,l5pro,n6pro no this
#define PPN3_RANGE_OFFSET		0x38
#define MINI_PPN4_OFFSET		0x3c
#define PPN4_RANGE_OFFSET		0x40
...
void mmu_vau_write_pate_totable(ulong pgt_base_addr, u32 entry_index, u32 ppn_addr) __attribute__((no_instrument_function));
