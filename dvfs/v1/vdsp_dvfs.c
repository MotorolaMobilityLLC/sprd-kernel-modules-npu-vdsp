...
static void vdsp_add_dec_level_tofile(struct file *filp,
	enum sprd_vdsp_kernel_power_level level, enum vdsp_powerhint_adddec_flag flag)
{
...
static enum sprd_vdsp_kernel_power_level translate_powerlevel_fromuser(
	struct xvp *xvp, int32_t in)
{
	enum sprd_vdsp_kernel_power_level level;
